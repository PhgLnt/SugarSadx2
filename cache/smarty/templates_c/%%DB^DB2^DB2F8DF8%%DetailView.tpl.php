<?php /* Smarty version 2.6.11, created on 2022-06-22 20:03:12
         compiled from cache/modules/P_CustomOrders/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/P_CustomOrders/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/P_CustomOrders/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/P_CustomOrders/DetailView.tpl', 47, false),array('function', 'sugar_ajax_url', 'cache/modules/P_CustomOrders/DetailView.tpl', 104, false),array('modifier', 'strip_semicolon', 'cache/modules/P_CustomOrders/DetailView.tpl', 48, false),array('modifier', 'escape', 'cache/modules/P_CustomOrders/DetailView.tpl', 172, false),array('modifier', 'url2html', 'cache/modules/P_CustomOrders/DetailView.tpl', 172, false),array('modifier', 'nl2br', 'cache/modules/P_CustomOrders/DetailView.tpl', 172, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='P_CustomOrders'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='P_CustomOrders'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='P_CustomOrders'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='P_CustomOrders'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div id="P_CustomOrders_detailview_tabs"
>
<div >
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['order_number_c']['name']; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['product_order_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PRODUCT_ORDER','module' => 'P_CustomOrders'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['product_order_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
"><?php echo $this->_tpl_vars['fields']['product_order_c']['value']; ?>
</span>

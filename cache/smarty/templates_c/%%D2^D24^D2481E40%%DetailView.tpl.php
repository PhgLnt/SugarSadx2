<?php /* Smarty version 2.6.11, created on 2022-06-24 05:16:57
         compiled from cache/modules/P_Something/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/P_Something/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/P_Something/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/P_Something/DetailView.tpl', 47, false),array('function', 'sugar_number_format', 'cache/modules/P_Something/DetailView.tpl', 84, false),array('modifier', 'strip_semicolon', 'cache/modules/P_Something/DetailView.tpl', 48, false),array('modifier', 'escape', 'cache/modules/P_Something/DetailView.tpl', 171, false),array('modifier', 'url2html', 'cache/modules/P_Something/DetailView.tpl', 171, false),array('modifier', 'nl2br', 'cache/modules/P_Something/DetailView.tpl', 171, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='P_Something'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='P_Something'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='P_Something'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='P_Something'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div id="P_Something_detailview_tabs"
>
<div >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['discount_number_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DISCOUNT_NUMBER','module' => 'P_Something'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['discount_number_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['discount_number_c']['name']; ?>
">
<?php echo smarty_function_sugar_number_format(array('var' => $this->_tpl_vars['fields']['discount_number_c']['value'],'precision' => 2), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['created_by_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'P_Something'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >

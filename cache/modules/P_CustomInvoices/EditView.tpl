...
{/if}  
<input type='text' name='{$fields.total_price_c.name}'
id='{$fields.total_price_c.name}'
size='30'
...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='P_CustomInvoices' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='P_CustomInvoices' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='P_CustomInvoices' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='P_CustomInvoices' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='P_CustomInvoices' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='P_CustomInvoices' for_js=true}{literal}' );
...
addToValidate('EditView', 'discount_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_DISCOUNT' module='P_CustomInvoices' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'created_by_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='P_CustomInvoices' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CREATED' module='P_CustomInvoices' for_js=true}{literal}', 'created_by' );

 ...
 $GLOBALS["dictionary"]["P_CustomInvoices"]=array (
  ...
  array (
    ...
    array (
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'P_CustomInvoicescustomer_invoice_c',
    ...
    array (
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'P_CustomInvoicesorder_name_c',
      'custom_module' => 'P_CustomInvoices',
    ),
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'P_CustomInvoicesproduct_information_c',
      'custom_module' => 'P_CustomInvoices',
    ),
    'voucher_c' => 
    array (
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id_name' => 'p_customvoucher_id_c',
      'ext2' => 'P_CustomVoucher',
      'module' => 'P_CustomVoucher',
      'rname' => 'name',
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'P_CustomInvoicesvoucher_discount_c',
      'custom_module' => 'P_CustomInvoices',
    ),
    'p_customvoucher_id_c' => 
    array (
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'p_customvoucher_id_c',
      'vname' => 'LBL_VOUCHER_DISCOUNT_P_CUSTOMVOUCHER_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'P_CustomInvoicesp_customvoucher_id_c',
      'custom_module' => 'P_CustomInvoices',
    ),
    'contact_id_c' => 
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'contact_id_c',
      'vname' => 'LBL_CUSTOMER_INVOICE_CONTACT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
